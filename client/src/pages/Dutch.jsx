...
const jobs = [
    { 
      ...
      description: "Wij zijn op zoek naar een betrouwbare en vriendelijke kassamedewerker die ons team komt versterken. Verantwoordelijkheden: Transacties afhandelen, uitstekende klantenservice bieden. Flexibel rooster. Eerdere ervaring is niet vereist. Bel alstublieft: 999-999-9999 en vraag het aan Mark. / We are looking for a reliable and friendly Cashier to join our team. Responsibilities: Handle transactions, provide excellent customer service. Flexible schedule. Previous experience not required. Please call: 999-999-9999 and ask Mark."
   },
  
    { 
      id: 2, 
      title: "vaatwasser / dishwasher",
  ...
  const Dutch = () => {
    return (
      <div className="container mx-auto px-4 py-8">
        <h2 className="text-3xl font-bold mb-4 text-purple-400">Jobs / Banen</h2>
        {jobs.map(job => (
